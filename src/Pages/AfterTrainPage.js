  ...
  return (
    <div className="product-card">
      <div className="product-container">
        <div className="product-image-container">
          <div className="bullet-points-container" >
            ...
            <div className="bullet-points">
              ...
              <p className="product-bullet-points">2.8g of Creatine Monohydrate to help build lean muscle mass and maximize performance. </p>
            </div>
            <div className="bullet-points">
        ...
        <div className="product-flavour flavour-apple">
                        <p>{product.flavour}</p>
                    </div>
